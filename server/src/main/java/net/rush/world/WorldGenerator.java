...
public interface WorldGenerator {
	...
	/*public static class WorldPopulate {
		...
		public void setType(int x, int y, int z, int type) {			
			getChunk(x, z).setType(x & 15, y, z & 15, type); // Important: Method does not send block update packet.
		}

		public void setTypeAndData(int x, int y, int z, int type, int data) {
			getChunk(x, z).setTypeAndData(x & 15, y, z & 15, type, data); // Important: Method does not send block update packet.
		}
		...
		public void setData(int x, int y, int z, int data) {
			getChunk(x, z).setData(x & 15, y, z & 15, data); // Important: Method does not send block update packet.
		}
